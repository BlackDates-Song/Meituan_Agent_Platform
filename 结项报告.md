...
**项目状态**：✅ 已完成并可交付  
**报告日期**：2026年1月15日  
**代码仓库**：https://github.com/BlackDates-Song/Meituan_Agent_Platform
...
**项目链接**：
- GitHub仓库：https://github.com/BlackDates-Song/Meituan_Agent_Platform
- 技术文档：见仓库README.md
- 用户指南：见仓库USER_GUIDE.md
...
**报告完成日期**：2026年1月15日  
**项目代码**：https://github.com/BlackDates-Song/Meituan_Agent_Platform  
**在线文档**：见仓库README
...
### A.1 代码仓库
- **GitHub地址**：https://github.com/BlackDates-Song/Meituan_Agent_Platform
- **分支**：main
- **代码量**：4,700行Python + 1,200行JavaScript
- **文件结构**：
  ```
  ├── backend/          # 后端服务（FastAPI）
  │   ├── api/          # LLM客户端封装
  │   ├── models/       # 推荐模型
  │   ├── services/     # RAG、Agent服务
  │   └── utils/        # 工具类
  ├── frontend/         # 前端界面（Vue 3）
  │   ├── index_v2.html # V2增强版
  │   └── static/       # CSS、JS资源
...
### A.2 数据说明
由于GitHub文件大小限制，以下数据文件**未包含在仓库中**，需本地准备：
- **Meituan_TRD/**：美团TRD数据集（2.1GB）
  - orders_train.txt (58MB)
  - orders_spu_train.txt (73MB)
  - graph.bin (1.8GB)
  - 其他数据文件
- **data/vector_db/**：ChromaDB向量索引（286MB）
- **backend/models/**：训练好的模型文件（.pkl、.npy）
